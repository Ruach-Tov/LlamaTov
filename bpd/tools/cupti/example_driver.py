...
import llamatov_run as R, dev_residency as dr
...
dr._DEVICE_KV_CACHE=True;dr._DEVICE_ATTN=True;dr._MASKED_ATTN=True;dr._SLAB.enabled=True;dr._GRAPH_PREP=True;dr._DEVICE_LOGITS=True;dr._KV_MAX_SEQ=256
def l2t(lg): return int(lg[0,-1].argmax().item())
dr._SLAB.base=None;dr._RESID_IN=None;dr._RESID_OUT=None;dr._LOGITS_BUF=None;dr._LOGITS_RMS=None
...
for _ in range(3): lg=gr.replay_logits(torch.tensor([g[-1]])); g.append(l2t(lg))
