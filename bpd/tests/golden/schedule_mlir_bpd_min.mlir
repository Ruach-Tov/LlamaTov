...
// GENERATED from SCHEDULE-IR (tiled_row_reduce, min) -> MLIR-GPU. One schedule, N backends.
...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^sb:
      ...
      %nacc_c = arith.cmpf olt, %v, %acc : f32
    ...
    ^sd(%acc1: f32):
      ...
      %w_r16_c = arith.cmpf olt, %w_s16, %acc1 : f32
      ...
      %w_r8_c = arith.cmpf olt, %w_s8, %w_r16 : f32
      ...
      %w_r4_c = arith.cmpf olt, %w_s4, %w_r8 : f32
      ...
      %w_r2_c = arith.cmpf olt, %w_s2, %w_r4 : f32
      ...
      %w_r1_c = arith.cmpf olt, %w_s1, %w_r2 : f32
