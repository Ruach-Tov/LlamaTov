...
// GENERATED MLIR-GPU 2D pool (max K=4 S=1 P=1 D=1) from op_expr(bpd_maxpool2d) -> NVVM -> PTX -> P4.
...
module attributes {gpu.container_module} {
  gpu.module @kernels {
    ...
    ^body:
      ...
      %Pad = llvm.mlir.constant(1 : i64) : i64
      %Dil = llvm.mlir.constant(1 : i64) : i64
      %K = llvm.mlir.constant(4 : i64) : i64
    ...
    ^khd(%accf: f32, %cntf: i64):
      %fz2 = llvm.mlir.constant(0.0 : f32) : f32
      %res = llvm.fadd %accf, %fz2 : f32
